...
| 属性分类器族（yolo26l-cls） | ✅ V1 双训（2026-09-09）；**2026-09-10 用户裁决：upper_body V1（test 0.974）为主力分类器；coarse V1（test 0.817）冻结**——coarse V2 doubao 重标计划随之取消（省商用费用），未来业务需要三类时再解冻。错误分析存档 `research/2026-09-09-coarse错误分析与V2方案.md` |
