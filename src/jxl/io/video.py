...
from jvi.drawing.color import COLORS7, Colors, random_color
from jvi.drawing.shape import polylines
from jvi.geo.point2d import Points
from jvi.geo.rectangle import Rect
from jvi.geo.size2d import SIZE_VGA, Size
...
class CmpVideoMaker(BaseModel):
    ...
    def make(
        ...
        for im, color in zip(images, self.colors, strict=False):
            if roi:
...
def demo_maker() -> None:
    ...
    r1 = Rect.new(0.0, 0.0, 0.5, 0.5)
    r2 = Rect.new(0.5, 0.5, 0.5, 0.5)
