# Vendored 2026-08-29 from NVlabs/Eagle (repo root Apache-2.0; Embodied/ 目录另带
# LICENSE_MODEL, 本文件头为 NVIDIA 专有条款 — 按 NVIDIA License 非商用解释, 仅限
# 研究/评估用途). 原样拷贝未修改:
# https://raw.githubusercontent.com/NVlabs/Eagle/main/Embodied/locateanything_worker.py
#
